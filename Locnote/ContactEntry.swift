...
class ContactEntry: NSObject {
    ...
    init?(cnContact: CNContact) {
        ...
        self.name = cnContact.givenName.trimmingCharacters(in: CharacterSet.whitespaces)
        
        // surName
        self.surName = cnContact.familyName.trimmingCharacters(in: CharacterSet.whitespaces)
